...
static safety_config volkswagen_meb_init(uint16_t param) {
  ...
  static RxCheck volkswagen_meb_rx_checks[] = {
    ...
    {.msg = {{MSG_Motor_51, 0, 48, .max_counter = 15U, .ignore_quality_flag = true, .ignore_checksum = true}, { 0 }, { 0 }}},
    {.msg = {{MSG_GRA_ACC_01, 0, 8, .max_counter = 15U, .ignore_quality_flag = true}, { 0 }, { 0 }}},
    {.msg = {{MSG_QFK_01, 0, 32, .max_counter = 15U, .ignore_quality_flag = true, .ignore_checksum = true}, { 0 }, { 0 }}},
    {.msg = {{MSG_ESC_51, 0, 64, .max_counter = 15U, .ignore_quality_flag = true, .ignore_checksum = true}, { 0 }, { 0 }}},
