...
class CarControllerParams:
    ...
    def __init__(self, CP):
        ...
        if CP.flags & VolkswagenFlags.PQ:
            ...
            self.STEER_DRIVER_ALLOWANCE = 30  # Driver torque 0.3 Nm, begin steering reduction from MAX
...
class CAR(Platforms):
    ...
    VOLKSWAGEN_CADDY_MK3 = VolkswagenPQPlatformConfig(
        ...
        VolkswagenCarSpecs(mass=1550, wheelbase=2.682, steerRatio=15.5, centerToFrontRatio=0.505,
                           tireStiffnessFactor=1.1),
        chassis_codes={"2K"},
    ...
    VOLKSWAGEN_JETTA_MK6 = VolkswagenPQPlatformConfig(
        ...
        VolkswagenCarSpecs(mass=1518, wheelbase=2.65, minSteerSpeed=50 * CV.KPH_TO_MS,
                           minEnableSpeed=20 * CV.KPH_TO_MS),
        chassis_codes={"5K", "AJ"},
    ...
    VOLKSWAGEN_PASSAT_NMS = VolkswagenPQPlatformConfig(
        ...
        VolkswagenCarSpecs(mass=1503, wheelbase=2.80, minSteerSpeed=50 * CV.KPH_TO_MS,
                           minEnableSpeed=20 * CV.KPH_TO_MS),
        chassis_codes={"A3"},
